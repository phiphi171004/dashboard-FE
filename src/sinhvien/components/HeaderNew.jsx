...
const HeaderNew = ({ onMenuClick, setCurrentPage }) => {
  ...
  return (
    <header className="bg-white border-b border-gray-200 shadow-sm relative z-50">
      ...
      {/* Profile Modal */}
      {profileModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center" style={{ zIndex: 110 }}>
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 relative" style={{ zIndex: 111 }}>
            {/* Modal Header */}
